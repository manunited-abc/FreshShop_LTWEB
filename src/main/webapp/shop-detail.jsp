...
<body>
	...
	<div class="shop-detail-box-main">
		...
		<c:set var="link1" value="${link1 }"></c:set>
		<c:set var="link2" value="${link2 }"></c:set>
					...
					<div id="carousel-example-1"
						...
						<div class="carousel-inner" role="listbox">
							<div class="carousel-item active">
								<img class="d-block w-100"
									src="images/image-product/${product.linkImage}"
									alt="First slide">
							</div>
						...
						<ol class="carousel-indicators" style="background: unset;margin-top:20px">
							<li data-target="#carousel-example-1" data-slide-to="0"
								...
								src="images/image-product/${product.linkImage}" alt="" /></li>
					...
					<c:forEach var="review" items="${listReviews}">
						<div class="media mb-3">
							...
							<div class="media-body">
								<h4><strong>${review.getName()}</strong> 
							<div id="ratings" >
							<c:if test="${review.rating.equals('5')}">
								...
								<small class="text-muted"><fmt:formatDate type="both" dateStyle="short" timeStyle="short"
					value="${ review.getDateReview().getTime()}" /></small>
							</div>
						</div>
						<hr>
					</c:forEach>
