...
public class Login extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (code == null || code.isEmpty()) {
		    ...
		    Customer customer = new Customer(googlePojo.getId(), googlePojo.getFamily_name(), googlePojo.getGiven_name(), googlePojo.getEmail(),"0"); 
		    if(khd.checkEmail(googlePojo.getEmail())) {
		    	 khd.insertCustomer(customer);
		    }
